<template>
    <div id="add-bus-owner">
        <div class="row">
            <div class="col-md-12">

                <div class="card card-primary">
                    <div class="card-header">Add Bus Owner</div>

                    <div class="card-body">
                        <form v-on:submit.prevent="addBusOwner">

                            <div class="form-group row">
                                <label class="control-label">Bus Group</label>
                                <select name="bus_group_id" v-model="busOwnerData.bus_group_id" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <select name="owner_id" v-model="busOwnerData.owner_id" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="date" name="assign_date" v-model="busOwnerData.assign_date" class="form-control">
      ...
      methods: {
        ...
        addBusOwner: async function(){
          try {
            ...
            await this.$store.dispatch('bus_owner/add_bus_owner', formData).then(() => {
              this.$swal.fire({
                toast: true,
                position: 'top-end',
                icon: 'success',
